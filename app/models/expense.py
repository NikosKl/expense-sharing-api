...
class Expense(Base):
    ...
    __table_args__ = (CheckConstraint(
        "split_type in ('equal', 'exact', 'percentage')", name='chk_expenses_split_type'),)
    ...
    splits: Mapped[List[ExpenseSplit]] = relationship(back_populates="expense", cascade="all, delete-orphan", passive_deletes=True)